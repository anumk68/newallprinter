...
<head>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $('#pleas').delay(1000).fadeIn(); $('#pleas').delay(16000).fadeOut();
      ...
      $('#showsol').delay(20000).fadeIn(); $('#showsol').delay(15034500).fadeOut();
        ...
        <div id="offme">
          ...
          <p id="searching-usb" style="text-align: center;">
            ...
            <span style="display: inline-flex; align-items: center;">
              ...
              <img src="{{ asset('public/images/loading.gif') }}" alt="Your Image" style="height: 32px; margin-right: 5px;">
