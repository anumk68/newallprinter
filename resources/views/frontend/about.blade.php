...
<section class="banner-section" style="background: linear-gradient(rgb(31 191 255 / 52%), rgb(31 191 255 / 52%)), url(public/images/about_bannner.png);">
  ...
  <div class="banner_content">
        ...
        <p class="mt-3">
          Printer Touch offers online printer maintenance services to deal with problems like updating drivers, paper jams, connectivity issues, or any other issues. Our team is dedicated to providing fast and reliable solutions to restore your printer to peak performance.  Printer Touch offers online printer maintenance services to deal with problems like updating drivers, paper jams, connectivity issues, or any other issues. Our team is dedicated to providing fast and reliable solutions to restore your printer to peak performance. Printer Touch offers online printer maintenance services to deal with problems like updating drivers, paper jams, connectivity issues, or any other issues. Our team is dedicated to providing fast and reliable solutions to restore your printer to peak performance.  
        </p>
  ...
  <div class="container">
    ...
    <div class="owl-carousel testimonial-slider">
      ...
      <div class="testimonial-box">
        ...
        <h3>John Davidson</h3>
        <div class="stars">★★★★★</div>
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum, pariatur placeat. Impedit, deserunt adipisci eligendi sit dolorem facere doloribus, eaque cupiditate quibusdam non voluptates enim amet officiis, iusto voluptatibus cumque?</p>
      </div>
